       ...
       PROGRAM-ID. PAY001.
      *****************************************************************
      * Program: Payroll Master File Load
      * Description: Processes PAYROLL.INPUT.MASTER, PAYROLL.INPUT.TRANS and produces
      *              PAYROLL.OUTPUT.PAY001, PAYROLL.REPORT.PAY001
      ...
      *****************************************************************
       ...
       FILE-CONTROL.
           ...
           SELECT PAYROLL-INPUT-TRANS-FILE
               ...
               ORGANIZATION IS SEQUENTIAL.
           SELECT PAYROLL-OUTPUT-PAY001-FILE
               ASSIGN TO PAYROLL.OUTPUT.PAY001
               ORGANIZATION IS SEQUENTIAL.
           SELECT PAYROLL-REPORT-PAY001-FILE
               ASSIGN TO PAYROLL.REPORT.PAY001
               ORGANIZATION IS SEQUENTIAL.
       ...
       01  PAYROLL-INPUT-TRANS-RECORD.
           ...
           05  FILLER                  PIC X(60).
       FD  PAYROLL-OUTPUT-PAY001-FILE.
       01  PAYROLL-OUTPUT-PAY001-RECORD.
           05  PAYROLL-OUTPUT-PAY001-KEY           PIC X(10).
           05  PAYROLL-OUTPUT-PAY001-DATA          PIC X(100).
           05  PAYROLL-OUTPUT-PAY001-AMOUNT        PIC 9(7)V99.
           05  PAYROLL-OUTPUT-PAY001-STATUS        PIC X(10).
           05  FILLER                  PIC X(60).
       FD  PAYROLL-REPORT-PAY001-FILE.
       01  PAYROLL-REPORT-PAY001-RECORD.
           05  PAYROLL-REPORT-PAY001-KEY           PIC X(10).
           05  PAYROLL-REPORT-PAY001-DATA          PIC X(100).
           05  PAYROLL-REPORT-PAY001-AMOUNT        PIC 9(7)V99.
           05  PAYROLL-REPORT-PAY001-STATUS        PIC X(10).
           05  FILLER                  PIC X(60).
       ...
       1000-INITIALIZE.
           DISPLAY '*** PAY001 STARTED ***'
           OPEN INPUT PAYROLL-INPUT-MASTER-FILE
           OPEN INPUT PAYROLL-INPUT-TRANS-FILE
           OPEN OUTPUT PAYROLL-OUTPUT-PAY001-FILE
           OPEN OUTPUT PAYROLL-REPORT-PAY001-FILE
           ...
           PERFORM UNTIL END-OF-FILE
               READ PAYROLL-INPUT-MASTER-FILE
                   ...
                   NOT AT END
                       ...
                       WRITE PAYROLL-OUTPUT-PAY001-RECORD
       ...
       3000-FINALIZE.
           ...
           CLOSE PAYROLL-OUTPUT-PAY001-FILE
           CLOSE PAYROLL-REPORT-PAY001-FILE
           DISPLAY '*** PAY001 COMPLETED ***'
