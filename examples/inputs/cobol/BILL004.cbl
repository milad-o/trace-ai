      ...
      *              BILLING.OUTPUT.BILL004, BILLING.REPORT.BILL004
      ...
      *****************************************************************
       ...
       FILE-CONTROL.
           ...
           SELECT BILLING-INPUT-TRANS-FILE
               ...
               ORGANIZATION IS SEQUENTIAL.
           SELECT BILLING-OUTPUT-BILL004-FILE
               ASSIGN TO BILLING.OUTPUT.BILL004
               ORGANIZATION IS SEQUENTIAL.
           SELECT BILLING-REPORT-BILL004-FILE
               ASSIGN TO BILLING.REPORT.BILL004
               ORGANIZATION IS SEQUENTIAL.
       ...
       01  BILLING-INPUT-TRANS-RECORD.
           ...
           05  FILLER                  PIC X(60).
       FD  BILLING-OUTPUT-BILL004-FILE.
       01  BILLING-OUTPUT-BILL004-RECORD.
           05  BILLING-OUTPUT-BILL004-KEY           PIC X(10).
           05  BILLING-OUTPUT-BILL004-DATA          PIC X(100).
           05  BILLING-OUTPUT-BILL004-AMOUNT        PIC 9(7)V99.
           05  BILLING-OUTPUT-BILL004-STATUS        PIC X(10).
           05  FILLER                  PIC X(60).
       FD  BILLING-REPORT-BILL004-FILE.
       01  BILLING-REPORT-BILL004-RECORD.
           05  BILLING-REPORT-BILL004-KEY           PIC X(10).
           05  BILLING-REPORT-BILL004-DATA          PIC X(100).
           05  BILLING-REPORT-BILL004-AMOUNT        PIC 9(7)V99.
           05  BILLING-REPORT-BILL004-STATUS        PIC X(10).
           05  FILLER                  PIC X(60).
       ...
       1000-INITIALIZE.
           DISPLAY '*** BILL004 STARTED ***'
           OPEN INPUT BILLING-INPUT-MASTER-FILE
           OPEN INPUT BILLING-INPUT-TRANS-FILE
           OPEN OUTPUT BILLING-OUTPUT-BILL004-FILE
           OPEN OUTPUT BILLING-REPORT-BILL004-FILE
           ...
           PERFORM UNTIL END-OF-FILE
               READ BILLING-INPUT-MASTER-FILE
                   ...
                   NOT AT END
                       ...
                       WRITE BILLING-OUTPUT-BILL004-RECORD
       ...
       3000-FINALIZE.
           ...
           CLOSE BILLING-OUTPUT-BILL004-FILE
           CLOSE BILLING-REPORT-BILL004-FILE
           DISPLAY '*** BILL004 COMPLETED ***'
