       ...
       PROGRAM-ID. SALE002.
      *****************************************************************
      * Program: Sales Transaction Validation
      * Description: Processes SALES.INPUT.MASTER, SALES.INPUT.TRANS and produces
      *              SALES.OUTPUT.SALE002, SALES.REPORT.SALE002
      ...
      *****************************************************************
       ...
       FILE-CONTROL.
           ...
           SELECT SALES-INPUT-TRANS-FILE
               ...
               ORGANIZATION IS SEQUENTIAL.
           SELECT SALES-OUTPUT-SALE002-FILE
               ASSIGN TO SALES.OUTPUT.SALE002
               ORGANIZATION IS SEQUENTIAL.
           SELECT SALES-REPORT-SALE002-FILE
               ASSIGN TO SALES.REPORT.SALE002
               ORGANIZATION IS SEQUENTIAL.
       ...
       01  SALES-INPUT-TRANS-RECORD.
           ...
           05  FILLER                  PIC X(60).
       FD  SALES-OUTPUT-SALE002-FILE.
       01  SALES-OUTPUT-SALE002-RECORD.
           05  SALES-OUTPUT-SALE002-KEY           PIC X(10).
           05  SALES-OUTPUT-SALE002-DATA          PIC X(100).
           05  SALES-OUTPUT-SALE002-AMOUNT        PIC 9(7)V99.
           05  SALES-OUTPUT-SALE002-STATUS        PIC X(10).
           05  FILLER                  PIC X(60).
       FD  SALES-REPORT-SALE002-FILE.
       01  SALES-REPORT-SALE002-RECORD.
           05  SALES-REPORT-SALE002-KEY           PIC X(10).
           05  SALES-REPORT-SALE002-DATA          PIC X(100).
           05  SALES-REPORT-SALE002-AMOUNT        PIC 9(7)V99.
           05  SALES-REPORT-SALE002-STATUS        PIC X(10).
           05  FILLER                  PIC X(60).
       ...
       1000-INITIALIZE.
           DISPLAY '*** SALE002 STARTED ***'
           OPEN INPUT SALES-INPUT-MASTER-FILE
           OPEN INPUT SALES-INPUT-TRANS-FILE
           OPEN OUTPUT SALES-OUTPUT-SALE002-FILE
           OPEN OUTPUT SALES-REPORT-SALE002-FILE
           ...
           PERFORM UNTIL END-OF-FILE
               READ SALES-INPUT-MASTER-FILE
                   ...
                   NOT AT END
                       ...
                       WRITE SALES-OUTPUT-SALE002-RECORD
       ...
       3000-FINALIZE.
           ...
           CLOSE SALES-OUTPUT-SALE002-FILE
           CLOSE SALES-REPORT-SALE002-FILE
           DISPLAY '*** SALE002 COMPLETED ***'
