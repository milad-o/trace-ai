       ...
       PROGRAM-ID. SALE005.
      *****************************************************************
      * Program: Sales Forecast Generator
      * Description: Processes SALES.INPUT.MASTER, SALES.INPUT.TRANS and produces
      *              SALES.OUTPUT.SALE005, SALES.REPORT.SALE005
      ...
      *****************************************************************
       ...
       FILE-CONTROL.
           ...
           SELECT SALES-INPUT-TRANS-FILE
               ...
               ORGANIZATION IS SEQUENTIAL.
           SELECT SALES-OUTPUT-SALE005-FILE
               ASSIGN TO SALES.OUTPUT.SALE005
               ORGANIZATION IS SEQUENTIAL.
           SELECT SALES-REPORT-SALE005-FILE
               ASSIGN TO SALES.REPORT.SALE005
               ORGANIZATION IS SEQUENTIAL.
       ...
       01  SALES-INPUT-TRANS-RECORD.
           ...
           05  FILLER                  PIC X(60).
       FD  SALES-OUTPUT-SALE005-FILE.
       01  SALES-OUTPUT-SALE005-RECORD.
           05  SALES-OUTPUT-SALE005-KEY           PIC X(10).
           05  SALES-OUTPUT-SALE005-DATA          PIC X(100).
           05  SALES-OUTPUT-SALE005-AMOUNT        PIC 9(7)V99.
           05  SALES-OUTPUT-SALE005-STATUS        PIC X(10).
           05  FILLER                  PIC X(60).
       FD  SALES-REPORT-SALE005-FILE.
       01  SALES-REPORT-SALE005-RECORD.
           05  SALES-REPORT-SALE005-KEY           PIC X(10).
           05  SALES-REPORT-SALE005-DATA          PIC X(100).
           05  SALES-REPORT-SALE005-AMOUNT        PIC 9(7)V99.
           05  SALES-REPORT-SALE005-STATUS        PIC X(10).
           05  FILLER                  PIC X(60).
       ...
       1000-INITIALIZE.
           DISPLAY '*** SALE005 STARTED ***'
           OPEN INPUT SALES-INPUT-MASTER-FILE
           OPEN INPUT SALES-INPUT-TRANS-FILE
           OPEN OUTPUT SALES-OUTPUT-SALE005-FILE
           OPEN OUTPUT SALES-REPORT-SALE005-FILE
           ...
           PERFORM UNTIL END-OF-FILE
               READ SALES-INPUT-MASTER-FILE
                   ...
                   NOT AT END
                       ...
                       WRITE SALES-OUTPUT-SALE005-RECORD
       ...
       3000-FINALIZE.
           ...
           CLOSE SALES-OUTPUT-SALE005-FILE
           CLOSE SALES-REPORT-SALE005-FILE
           DISPLAY '*** SALE005 COMPLETED ***'
