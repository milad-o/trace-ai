       ...
       PROGRAM-ID. PAY002.
      *****************************************************************
      * Program: Payroll Hours Validation
      * Description: Processes PAYROLL.INPUT.MASTER, PAYROLL.INPUT.TRANS and produces
      *              PAYROLL.OUTPUT.PAY002, PAYROLL.REPORT.PAY002
      ...
      *****************************************************************
       ...
       FILE-CONTROL.
           ...
           SELECT PAYROLL-INPUT-TRANS-FILE
               ...
               ORGANIZATION IS SEQUENTIAL.
           SELECT PAYROLL-OUTPUT-PAY002-FILE
               ASSIGN TO PAYROLL.OUTPUT.PAY002
               ORGANIZATION IS SEQUENTIAL.
           SELECT PAYROLL-REPORT-PAY002-FILE
               ASSIGN TO PAYROLL.REPORT.PAY002
               ORGANIZATION IS SEQUENTIAL.
       ...
       01  PAYROLL-INPUT-TRANS-RECORD.
           ...
           05  FILLER                  PIC X(60).
       FD  PAYROLL-OUTPUT-PAY002-FILE.
       01  PAYROLL-OUTPUT-PAY002-RECORD.
           05  PAYROLL-OUTPUT-PAY002-KEY           PIC X(10).
           05  PAYROLL-OUTPUT-PAY002-DATA          PIC X(100).
           05  PAYROLL-OUTPUT-PAY002-AMOUNT        PIC 9(7)V99.
           05  PAYROLL-OUTPUT-PAY002-STATUS        PIC X(10).
           05  FILLER                  PIC X(60).
       FD  PAYROLL-REPORT-PAY002-FILE.
       01  PAYROLL-REPORT-PAY002-RECORD.
           05  PAYROLL-REPORT-PAY002-KEY           PIC X(10).
           05  PAYROLL-REPORT-PAY002-DATA          PIC X(100).
           05  PAYROLL-REPORT-PAY002-AMOUNT        PIC 9(7)V99.
           05  PAYROLL-REPORT-PAY002-STATUS        PIC X(10).
           05  FILLER                  PIC X(60).
       ...
       1000-INITIALIZE.
           DISPLAY '*** PAY002 STARTED ***'
           OPEN INPUT PAYROLL-INPUT-MASTER-FILE
           OPEN INPUT PAYROLL-INPUT-TRANS-FILE
           OPEN OUTPUT PAYROLL-OUTPUT-PAY002-FILE
           OPEN OUTPUT PAYROLL-REPORT-PAY002-FILE
           ...
           PERFORM UNTIL END-OF-FILE
               READ PAYROLL-INPUT-MASTER-FILE
                   ...
                   NOT AT END
                       ...
                       WRITE PAYROLL-OUTPUT-PAY002-RECORD
       ...
       3000-FINALIZE.
           ...
           CLOSE PAYROLL-OUTPUT-PAY002-FILE
           CLOSE PAYROLL-REPORT-PAY002-FILE
           DISPLAY '*** PAY002 COMPLETED ***'
