       ...
       PROGRAM-ID. PAY005.
      *****************************************************************
      * Program: Payroll Deduction Processing
      * Description: Processes PAYROLL.INPUT.MASTER, PAYROLL.INPUT.TRANS and produces
      *              PAYROLL.OUTPUT.PAY005, PAYROLL.REPORT.PAY005
      ...
      *****************************************************************
       ...
       FILE-CONTROL.
           ...
           SELECT PAYROLL-INPUT-TRANS-FILE
               ...
               ORGANIZATION IS SEQUENTIAL.
           SELECT PAYROLL-OUTPUT-PAY005-FILE
               ASSIGN TO PAYROLL.OUTPUT.PAY005
               ORGANIZATION IS SEQUENTIAL.
           SELECT PAYROLL-REPORT-PAY005-FILE
               ASSIGN TO PAYROLL.REPORT.PAY005
               ORGANIZATION IS SEQUENTIAL.
       ...
       01  PAYROLL-INPUT-TRANS-RECORD.
           ...
           05  FILLER                  PIC X(60).
       FD  PAYROLL-OUTPUT-PAY005-FILE.
       01  PAYROLL-OUTPUT-PAY005-RECORD.
           05  PAYROLL-OUTPUT-PAY005-KEY           PIC X(10).
           05  PAYROLL-OUTPUT-PAY005-DATA          PIC X(100).
           05  PAYROLL-OUTPUT-PAY005-AMOUNT        PIC 9(7)V99.
           05  PAYROLL-OUTPUT-PAY005-STATUS        PIC X(10).
           05  FILLER                  PIC X(60).
       FD  PAYROLL-REPORT-PAY005-FILE.
       01  PAYROLL-REPORT-PAY005-RECORD.
           05  PAYROLL-REPORT-PAY005-KEY           PIC X(10).
           05  PAYROLL-REPORT-PAY005-DATA          PIC X(100).
           05  PAYROLL-REPORT-PAY005-AMOUNT        PIC 9(7)V99.
           05  PAYROLL-REPORT-PAY005-STATUS        PIC X(10).
           05  FILLER                  PIC X(60).
       ...
       1000-INITIALIZE.
           DISPLAY '*** PAY005 STARTED ***'
           OPEN INPUT PAYROLL-INPUT-MASTER-FILE
           OPEN INPUT PAYROLL-INPUT-TRANS-FILE
           OPEN OUTPUT PAYROLL-OUTPUT-PAY005-FILE
           OPEN OUTPUT PAYROLL-REPORT-PAY005-FILE
           ...
           PERFORM UNTIL END-OF-FILE
               READ PAYROLL-INPUT-MASTER-FILE
                   ...
                   NOT AT END
                       ...
                       WRITE PAYROLL-OUTPUT-PAY005-RECORD
                       ADD 1 TO WS-RECORD-COUNT
               END-READ
           END-PERFORM.
           CALL "UTIL002" USING PAYROLL-INPUT-MASTER-RECORD
       ...
       3000-FINALIZE.
           ...
           CLOSE PAYROLL-OUTPUT-PAY005-FILE
           CLOSE PAYROLL-REPORT-PAY005-FILE
           DISPLAY '*** PAY005 COMPLETED ***'
