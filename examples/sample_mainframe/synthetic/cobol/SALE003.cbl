       ...
       PROGRAM-ID. SALE003.
      *****************************************************************
      * Program: Sales Commission Calculation
      * Description: Processes SALES.INPUT.MASTER, SALES.INPUT.TRANS and produces
      *              SALES.OUTPUT.SALE003, SALES.REPORT.SALE003
      ...
      *****************************************************************
       ...
       FILE-CONTROL.
           ...
           SELECT SALES-INPUT-TRANS-FILE
               ...
               ORGANIZATION IS SEQUENTIAL.
           SELECT SALES-OUTPUT-SALE003-FILE
               ASSIGN TO SALES.OUTPUT.SALE003
               ORGANIZATION IS SEQUENTIAL.
           SELECT SALES-REPORT-SALE003-FILE
               ASSIGN TO SALES.REPORT.SALE003
               ORGANIZATION IS SEQUENTIAL.
       ...
       01  SALES-INPUT-TRANS-RECORD.
           ...
           05  FILLER                  PIC X(60).
       FD  SALES-OUTPUT-SALE003-FILE.
       01  SALES-OUTPUT-SALE003-RECORD.
           05  SALES-OUTPUT-SALE003-KEY           PIC X(10).
           05  SALES-OUTPUT-SALE003-DATA          PIC X(100).
           05  SALES-OUTPUT-SALE003-AMOUNT        PIC 9(7)V99.
           05  SALES-OUTPUT-SALE003-STATUS        PIC X(10).
           05  FILLER                  PIC X(60).
       FD  SALES-REPORT-SALE003-FILE.
       01  SALES-REPORT-SALE003-RECORD.
           05  SALES-REPORT-SALE003-KEY           PIC X(10).
           05  SALES-REPORT-SALE003-DATA          PIC X(100).
           05  SALES-REPORT-SALE003-AMOUNT        PIC 9(7)V99.
           05  SALES-REPORT-SALE003-STATUS        PIC X(10).
           05  FILLER                  PIC X(60).
       ...
       1000-INITIALIZE.
           DISPLAY '*** SALE003 STARTED ***'
           OPEN INPUT SALES-INPUT-MASTER-FILE
           OPEN INPUT SALES-INPUT-TRANS-FILE
           OPEN OUTPUT SALES-OUTPUT-SALE003-FILE
           OPEN OUTPUT SALES-REPORT-SALE003-FILE
           ...
           PERFORM UNTIL END-OF-FILE
               READ SALES-INPUT-MASTER-FILE
                   ...
                   NOT AT END
                       ...
                       WRITE SALES-OUTPUT-SALE003-RECORD
       ...
       3000-FINALIZE.
           ...
           CLOSE SALES-OUTPUT-SALE003-FILE
           CLOSE SALES-REPORT-SALE003-FILE
           DISPLAY '*** SALE003 COMPLETED ***'
