      ...
      *****************************************************************
       ...
       FILE-CONTROL.
           ...
           SELECT PAYROLL-INPUT-TRANS-FILE
               ...
               ORGANIZATION IS SEQUENTIAL.
           SELECT PAYROLL-OUTPUT-PAY003-FILE
               ASSIGN TO PAYROLL.OUTPUT.PAY003
               ORGANIZATION IS SEQUENTIAL.
           SELECT PAYROLL-REPORT-PAY003-FILE
               ASSIGN TO PAYROLL.REPORT.PAY003
               ORGANIZATION IS SEQUENTIAL.
       ...
       01  PAYROLL-INPUT-TRANS-RECORD.
           ...
           05  FILLER                  PIC X(60).
       FD  PAYROLL-OUTPUT-PAY003-FILE.
       01  PAYROLL-OUTPUT-PAY003-RECORD.
           05  PAYROLL-OUTPUT-PAY003-KEY           PIC X(10).
           05  PAYROLL-OUTPUT-PAY003-DATA          PIC X(100).
           05  PAYROLL-OUTPUT-PAY003-AMOUNT        PIC 9(7)V99.
           05  PAYROLL-OUTPUT-PAY003-STATUS        PIC X(10).
           05  FILLER                  PIC X(60).
       FD  PAYROLL-REPORT-PAY003-FILE.
       01  PAYROLL-REPORT-PAY003-RECORD.
           05  PAYROLL-REPORT-PAY003-KEY           PIC X(10).
           05  PAYROLL-REPORT-PAY003-DATA          PIC X(100).
           05  PAYROLL-REPORT-PAY003-AMOUNT        PIC 9(7)V99.
           05  PAYROLL-REPORT-PAY003-STATUS        PIC X(10).
           05  FILLER                  PIC X(60).
       ...
       1000-INITIALIZE.
           DISPLAY '*** PAY003 STARTED ***'
           OPEN INPUT PAYROLL-INPUT-MASTER-FILE
           OPEN INPUT PAYROLL-INPUT-TRANS-FILE
           OPEN OUTPUT PAYROLL-OUTPUT-PAY003-FILE
           OPEN OUTPUT PAYROLL-REPORT-PAY003-FILE
           ...
           PERFORM UNTIL END-OF-FILE
               READ PAYROLL-INPUT-MASTER-FILE
                   ...
                   NOT AT END
                       ...
                       WRITE PAYROLL-OUTPUT-PAY003-RECORD
       ...
       3000-FINALIZE.
           ...
           CLOSE PAYROLL-OUTPUT-PAY003-FILE
           CLOSE PAYROLL-REPORT-PAY003-FILE
           DISPLAY '*** PAY003 COMPLETED ***'
