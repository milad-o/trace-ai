      ...
      *****************************************************************
       ...
       FILE-CONTROL.
           ...
           SELECT BILLING-INPUT-TRANS-FILE
               ...
               ORGANIZATION IS SEQUENTIAL.
           SELECT BILLING-OUTPUT-BILL001-FILE
               ASSIGN TO BILLING.OUTPUT.BILL001
               ORGANIZATION IS SEQUENTIAL.
           SELECT BILLING-REPORT-BILL001-FILE
               ASSIGN TO BILLING.REPORT.BILL001
               ORGANIZATION IS SEQUENTIAL.
       ...
       01  BILLING-INPUT-TRANS-RECORD.
           ...
           05  FILLER                  PIC X(60).
       FD  BILLING-OUTPUT-BILL001-FILE.
       01  BILLING-OUTPUT-BILL001-RECORD.
           05  BILLING-OUTPUT-BILL001-KEY           PIC X(10).
           05  BILLING-OUTPUT-BILL001-DATA          PIC X(100).
           05  BILLING-OUTPUT-BILL001-AMOUNT        PIC 9(7)V99.
           05  BILLING-OUTPUT-BILL001-STATUS        PIC X(10).
           05  FILLER                  PIC X(60).
       FD  BILLING-REPORT-BILL001-FILE.
       01  BILLING-REPORT-BILL001-RECORD.
           05  BILLING-REPORT-BILL001-KEY           PIC X(10).
           05  BILLING-REPORT-BILL001-DATA          PIC X(100).
           05  BILLING-REPORT-BILL001-AMOUNT        PIC 9(7)V99.
           05  BILLING-REPORT-BILL001-STATUS        PIC X(10).
           05  FILLER                  PIC X(60).
       ...
       1000-INITIALIZE.
           DISPLAY '*** BILL001 STARTED ***'
           OPEN INPUT BILLING-INPUT-MASTER-FILE
           OPEN INPUT BILLING-INPUT-TRANS-FILE
           OPEN OUTPUT BILLING-OUTPUT-BILL001-FILE
           OPEN OUTPUT BILLING-REPORT-BILL001-FILE
           ...
           PERFORM UNTIL END-OF-FILE
               READ BILLING-INPUT-MASTER-FILE
                   ...
                   NOT AT END
                       ...
                       WRITE BILLING-OUTPUT-BILL001-RECORD
       ...
       3000-FINALIZE.
           ...
           CLOSE BILLING-OUTPUT-BILL001-FILE
           CLOSE BILLING-REPORT-BILL001-FILE
           DISPLAY '*** BILL001 COMPLETED ***'
