      ...
      *              BILLING.OUTPUT.BILL003, BILLING.REPORT.BILL003
      ...
      *****************************************************************
       ...
       FILE-CONTROL.
           ...
           SELECT BILLING-INPUT-TRANS-FILE
               ...
               ORGANIZATION IS SEQUENTIAL.
           SELECT BILLING-OUTPUT-BILL003-FILE
               ASSIGN TO BILLING.OUTPUT.BILL003
               ORGANIZATION IS SEQUENTIAL.
           SELECT BILLING-REPORT-BILL003-FILE
               ASSIGN TO BILLING.REPORT.BILL003
               ORGANIZATION IS SEQUENTIAL.
       ...
       01  BILLING-INPUT-TRANS-RECORD.
           ...
           05  FILLER                  PIC X(60).
       FD  BILLING-OUTPUT-BILL003-FILE.
       01  BILLING-OUTPUT-BILL003-RECORD.
           05  BILLING-OUTPUT-BILL003-KEY           PIC X(10).
           05  BILLING-OUTPUT-BILL003-DATA          PIC X(100).
           05  BILLING-OUTPUT-BILL003-AMOUNT        PIC 9(7)V99.
           05  BILLING-OUTPUT-BILL003-STATUS        PIC X(10).
           05  FILLER                  PIC X(60).
       FD  BILLING-REPORT-BILL003-FILE.
       01  BILLING-REPORT-BILL003-RECORD.
           05  BILLING-REPORT-BILL003-KEY           PIC X(10).
           05  BILLING-REPORT-BILL003-DATA          PIC X(100).
           05  BILLING-REPORT-BILL003-AMOUNT        PIC 9(7)V99.
           05  BILLING-REPORT-BILL003-STATUS        PIC X(10).
           05  FILLER                  PIC X(60).
       ...
       1000-INITIALIZE.
           DISPLAY '*** BILL003 STARTED ***'
           OPEN INPUT BILLING-INPUT-MASTER-FILE
           OPEN INPUT BILLING-INPUT-TRANS-FILE
           OPEN OUTPUT BILLING-OUTPUT-BILL003-FILE
           OPEN OUTPUT BILLING-REPORT-BILL003-FILE
           ...
           PERFORM UNTIL END-OF-FILE
               READ BILLING-INPUT-MASTER-FILE
                   ...
                   NOT AT END
                       ...
                       WRITE BILLING-OUTPUT-BILL003-RECORD
       ...
       3000-FINALIZE.
           ...
           CLOSE BILLING-OUTPUT-BILL003-FILE
           CLOSE BILLING-REPORT-BILL003-FILE
           DISPLAY '*** BILL003 COMPLETED ***'
