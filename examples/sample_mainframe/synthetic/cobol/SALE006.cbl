      ...
      *****************************************************************
       ...
       FILE-CONTROL.
           ...
           SELECT SALES-INPUT-TRANS-FILE
               ...
               ORGANIZATION IS SEQUENTIAL.
           SELECT SALES-OUTPUT-SALE006-FILE
               ASSIGN TO SALES.OUTPUT.SALE006
               ORGANIZATION IS SEQUENTIAL.
           SELECT SALES-REPORT-SALE006-FILE
               ASSIGN TO SALES.REPORT.SALE006
               ORGANIZATION IS SEQUENTIAL.
       ...
       01  SALES-INPUT-TRANS-RECORD.
           ...
           05  FILLER                  PIC X(60).
       FD  SALES-OUTPUT-SALE006-FILE.
       01  SALES-OUTPUT-SALE006-RECORD.
           05  SALES-OUTPUT-SALE006-KEY           PIC X(10).
           05  SALES-OUTPUT-SALE006-DATA          PIC X(100).
           05  SALES-OUTPUT-SALE006-AMOUNT        PIC 9(7)V99.
           05  SALES-OUTPUT-SALE006-STATUS        PIC X(10).
           05  FILLER                  PIC X(60).
       FD  SALES-REPORT-SALE006-FILE.
       01  SALES-REPORT-SALE006-RECORD.
           05  SALES-REPORT-SALE006-KEY           PIC X(10).
           05  SALES-REPORT-SALE006-DATA          PIC X(100).
           05  SALES-REPORT-SALE006-AMOUNT        PIC 9(7)V99.
           05  SALES-REPORT-SALE006-STATUS        PIC X(10).
           05  FILLER                  PIC X(60).
       ...
       1000-INITIALIZE.
           DISPLAY '*** SALE006 STARTED ***'
           OPEN INPUT SALES-INPUT-MASTER-FILE
           OPEN INPUT SALES-INPUT-TRANS-FILE
           OPEN OUTPUT SALES-OUTPUT-SALE006-FILE
           OPEN OUTPUT SALES-REPORT-SALE006-FILE
           ...
           PERFORM UNTIL END-OF-FILE
               READ SALES-INPUT-MASTER-FILE
                   ...
                   NOT AT END
                       ...
                       WRITE SALES-OUTPUT-SALE006-RECORD
                       ADD 1 TO WS-RECORD-COUNT
               END-READ
           END-PERFORM.
           CALL "UTIL002" USING SALES-INPUT-MASTER-RECORD
       ...
       3000-FINALIZE.
           ...
           CLOSE SALES-OUTPUT-SALE006-FILE
           CLOSE SALES-REPORT-SALE006-FILE
           DISPLAY '*** SALE006 COMPLETED ***'
