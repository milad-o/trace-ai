      ...
      *              BILLING.OUTPUT.BILL006, BILLING.REPORT.BILL006
      ...
      *****************************************************************
       ...
       FILE-CONTROL.
           ...
           SELECT BILLING-INPUT-TRANS-FILE
               ...
               ORGANIZATION IS SEQUENTIAL.
           SELECT BILLING-OUTPUT-BILL006-FILE
               ASSIGN TO BILLING.OUTPUT.BILL006
               ORGANIZATION IS SEQUENTIAL.
           SELECT BILLING-REPORT-BILL006-FILE
               ASSIGN TO BILLING.REPORT.BILL006
               ORGANIZATION IS SEQUENTIAL.
       ...
       01  BILLING-INPUT-TRANS-RECORD.
           ...
           05  FILLER                  PIC X(60).
       FD  BILLING-OUTPUT-BILL006-FILE.
       01  BILLING-OUTPUT-BILL006-RECORD.
           05  BILLING-OUTPUT-BILL006-KEY           PIC X(10).
           05  BILLING-OUTPUT-BILL006-DATA          PIC X(100).
           05  BILLING-OUTPUT-BILL006-AMOUNT        PIC 9(7)V99.
           05  BILLING-OUTPUT-BILL006-STATUS        PIC X(10).
           05  FILLER                  PIC X(60).
       FD  BILLING-REPORT-BILL006-FILE.
       01  BILLING-REPORT-BILL006-RECORD.
           05  BILLING-REPORT-BILL006-KEY           PIC X(10).
           05  BILLING-REPORT-BILL006-DATA          PIC X(100).
           05  BILLING-REPORT-BILL006-AMOUNT        PIC 9(7)V99.
           05  BILLING-REPORT-BILL006-STATUS        PIC X(10).
           05  FILLER                  PIC X(60).
       ...
       1000-INITIALIZE.
           DISPLAY '*** BILL006 STARTED ***'
           OPEN INPUT BILLING-INPUT-MASTER-FILE
           OPEN INPUT BILLING-INPUT-TRANS-FILE
           OPEN OUTPUT BILLING-OUTPUT-BILL006-FILE
           OPEN OUTPUT BILLING-REPORT-BILL006-FILE
           ...
           PERFORM UNTIL END-OF-FILE
               READ BILLING-INPUT-MASTER-FILE
                   ...
                   NOT AT END
                       ...
                       WRITE BILLING-OUTPUT-BILL006-RECORD
       ...
       3000-FINALIZE.
           ...
           CLOSE BILLING-OUTPUT-BILL006-FILE
           CLOSE BILLING-REPORT-BILL006-FILE
           DISPLAY '*** BILL006 COMPLETED ***'
